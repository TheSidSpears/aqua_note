 ...
 */
class Version20171105183113 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        // Uncomment if 'Integrity constraint violation' error
        /*
        $this->addSql('UPDATE genus SET sub_family_id=1');
        $this->addSql('INSERT INTO sub_family (name) VALUES (\'Test\')');
        */
